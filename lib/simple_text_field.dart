...
class SimpleTextField extends StatelessWidget {
  ...
  InputDecoration _getInputDecoration(ThemeData themeData) {
    ...
    final defFocusedBorderSide = BorderSide(width: decoration.focusedBorderWidth);

    final borderColor = decoration.borderColor
        ?? themeData.colorScheme.onSurface.withOpacity(0.38);
    final errorBorderColor = decoration.errorBorderColor
    ...
    return InputDecoration(
      ...
      border: decoration.removeBorder
          ? InputBorder.none
          : decoration.simpleBorder ? border : decoration.border,
      errorBorder: decoration.removeBorder
          ? InputBorder.none
          : decoration.simpleBorder ? errorBorder : decoration.errorBorder,
      focusedBorder: decoration.removeBorder
          ? InputBorder.none
          : decoration.simpleBorder ? focusedBorder : decoration.focusedBorder,
      focusedErrorBorder: decoration.removeBorder
          ? InputBorder.none
          : decoration.simpleBorder ? focusedErrorBorder : decoration.focusedErrorBorder,
      enabledBorder: decoration.removeBorder
          ? InputBorder.none
          : decoration.simpleBorder ? border : decoration.enabledBorder,
      disabledBorder: decoration.removeBorder
          ? InputBorder.none
          : decoration.simpleBorder ? border : decoration.disabledBorder,
